...
public class God implements Parametres {
    ...
    private void makeCombinaison(ArrayList<Choix> combinaison, Dimension3 jeu)
    {
    ...
    private Choix simulationDirection(Dimension3 jeu, int direction)
    {
        int repeat = 50;
    ...
    private Dimension3 clone(Dimension3 original)
    {
        ...
        for( int i = 0 ; i < ETAGE ; i++ )
        {
            ...
            {
                Case cN = new Case(c.getX(), c.getY(), c.getValeur());
